...
__ALIGN_BEGIN static uint8_t USBD_AUDIO_CfgDesc[USB_AUDIO_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  LOBYTE(USB_AUDIO_CONFIG_DESC_SIZ),    /* wTotalLength  133 bytes*/
  ...
  AUDIO_SAMPLE_FREQ(88200),             /* Audio sampling frequency coded on 3 bytes */
  ...
  AUDIO_PACKET_SZE_16B(96000),          /* wMaxPacketSize in Bytes (Freq(Samples)*2(Stereo)*2(16bit)) */
  0x01,                                 /* bInterval */
  0x00,                                 /* bRefresh */
  ...
  0x04,                                  /* bSamFreqType 3 frequencies supported */
  AUDIO_SAMPLE_FREQ(44100),              /* Audio sampling frequency coded on 3 bytes */
  AUDIO_SAMPLE_FREQ(48000),              /* Audio sampling frequency coded on 3 bytes */
  AUDIO_SAMPLE_FREQ(88200),              /* Audio sampling frequency coded on 3 bytes */
  AUDIO_SAMPLE_FREQ(96000),              /* Audio sampling frequency coded on 3 bytes */
  ...
  AUDIO_OUT_EP,                         /* bEndpointAddress 1 out endpoint*/
  USBD_EP_TYPE_ISOC_ASYNC,              /* bmAttributes */
  AUDIO_PACKET_SZE_24B(96000),		    /* wMaxPacketSize in Bytes (freq / 1000 + extra_samples) * channels * bytes_per_sample */
  0x01,                                 /* bInterval */
  0x00,                                 /* bRefresh */
  AUDIO_IN_EP,                          /* bSynchAddress */
  /* 09 byte*/
